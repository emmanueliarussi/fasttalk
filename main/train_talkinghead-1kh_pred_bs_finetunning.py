...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # =========== Load checkpoint ===========
    checkpoint_path = "/mnt/fasttalk/logs/talkinghead/talkinghead-s2/model_260/model.pth.tar" 
    ...
    # Initialize frozen residual base after loading pretrained weights
    if getattr(cfg, "use_residual", False):
        if cfg.distributed:
            model.module.init_residual_base()
        else:
            model.init_residual_base()
    # =========== End load checkpoint ===========
